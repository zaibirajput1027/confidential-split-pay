...
import { conditionalUnionType, unionType, validateUserConfigZodType, } from "@nomicfoundation/hardhat-zod-utils";
import { z } from "zod";
const mochaConfigType = z.object({
    ...
    timeout: unionType([z.number(), z.string()], "Expected a number or a string").optional(),
    ui: unionType([
        z.literal("bdd"),
        z.literal("tdd"),
        z.literal("qunit"),
        z.literal("exports"),
    ], 'Expected "bdd", "tdd", "qunit" or "exports"').optional(),
    parallel: z.boolean().optional(),
    jobs: z.number().optional(),
    rootHooks: z
        .object({
        afterAll: unionType([z.function(), z.array(z.function())], "Expected a function or an array of functions").optional(),
        beforeAll: unionType([z.function(), z.array(z.function())], "Expected a function or an array of functions").optional(),
        afterEach: unionType([z.function(), z.array(z.function())], "Expected a function or an array of functions").optional(),
        beforeEach: unionType([z.function(), z.array(z.function())], "Expected a function or an array of functions").optional(),
    })
        .optional(),
...
const userConfigType = z.object({
    ...
    paths: z
        ...
        ], "Expected a string or an object with an optional 'mocha' property").optional(),
    })
        .optional(),
});
