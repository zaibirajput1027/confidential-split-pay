...
(function (ExecutionEventType) {
    ...
    ExecutionEventType["TRANSACTION_PREPARE_SEND"] = "TRANSACTION_PREPARE_SEND";
 ...
 * @beta
 */
export var ExecutionEventNetworkInteractionType;
...
})(ExecutionEventNetworkInteractionType || (ExecutionEventNetworkInteractionType = {}));
/**
 * The status of a future's completed execution.
 *
 * @beta
 */
export var ExecutionEventResultType;
...
})(ExecutionEventResultType || (ExecutionEventResultType = {}));
