...
export declare function validateTasksConfig(tasks: TaskDefinition[], path?: Array<string | number>): HardhatUserConfigValidationError[];
...
export declare function validateNewTask(task: NewTaskDefinition, path: Array<string | number>): HardhatUserConfigValidationError[];
export declare function validateTaskOverride(task: TaskOverrideDefinition, path: Array<string | number>): HardhatUserConfigValidationError[];
