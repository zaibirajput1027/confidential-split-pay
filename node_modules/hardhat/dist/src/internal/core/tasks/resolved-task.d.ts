...
import type { LazyActionObject, NewTaskActionFunction, Task, TaskActions, TaskArguments } from "../../../types/tasks.js";
export declare class ResolvedTask implements Task {
    ...
    static createNewTask(hre: HardhatRuntimeEnvironment, id: string[], description: string, action: LazyActionObject<NewTaskActionFunction>, options: Record<string, OptionDefinition>, positionalArguments: PositionalArgumentDefinition[], pluginId?: string): ResolvedTask;
