 ...
 * reporter's design.
 */
export declare function testReporter(source: TestEventSource, sourceNameToUserSourceName: Map<string, string>, verbosity: number, colorizer?: Colorizer): TestReporterResult;
