...
export declare function resolveEdrNetwork(networkConfig: EdrNetworkUserConfig, cachePath: string, resolveConfigurationVariable: ConfigurationVariableResolver): EdrNetworkConfig;
...
export declare function resolveHardfork(hardfork: string | undefined, chainType?: ChainType | undefined): string;
