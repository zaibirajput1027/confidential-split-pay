import type { EdrNetworkForkingConfig, EdrNetworkHDAccountsConfig, EdrNetworkMiningConfig, HardhatUserConfig, HttpNetworkHDAccountsConfig, HttpNetworkHDAccountsUserConfig, NetworkUserConfig } from "../../../types/config.js";
...
export declare function validateNetworkConfigOverride(networkConfigOverride: NetworkUserConfig): Promise<HardhatUserConfigValidationError[]>;
